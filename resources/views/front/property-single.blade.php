        ...
        <div class="row" >
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">
                  مشروع {{  $property->project->name }}
                </li>
                <li class="breadcrumb-item">
                  <a href="{{ route('front.properties.index') }}">الوحدات</a>
                </li>
          ...
          <div class="col-md-12 col-lg-8" dir="rtl" >
            <div class="title-single-box">
              ...
              <span class="color-text-a">{{ $property->project->name }}</span>
            </div>
          </div>
                ...
                <div class="property-price d-flex justify-content-center foo">
                  <div class="card-header-c d-flex">
                    <div class="card-box-ico">
                      <span class="bi bi-cash">جنيه</span>
                    </div>
          ...
          <div class="col-md-10 offset-md-1">
            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <div class="tab-pane fade" id="pills-plans" role="tabpanel" aria-labelledby="pills-plans-tab">
                <img src="{{asset('front')}}/assets/img/plan2.jpg" alt="" class="img-fluid">
              </div>
