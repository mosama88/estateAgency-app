...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="{{ asset('front') }}/assets/login/css/font-awesome.min.css">
	
	<link rel="stylesheet" href="{{ asset('front') }}/assets/login/css/style.css">
    
	</head>
	<body class="img js-fullheight" style="background-image: url({{ 'front/assets/img/house.jpg' }});">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">الدخول</h2>
				</div>
			</div>
			<div class="row justify-content-center">
