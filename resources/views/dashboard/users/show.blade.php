                                        ...
                                        <div class="simplebar-content" style="padding: 0px 16px;">
                                            <div class="d-flex align-items-start border-bottom pb-4">
                                                <div class="flex-shrink-0 me-2">
                                                    <img class="rounded-circle avatar-sm" src="{{ asset('dashboard') }}/assets/images/users/avatar-3.jpg" alt="avatar-3 images">
                                                </div>
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex align-items-start mt-4">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img class="rounded-circle avatar-sm" src="{{ asset('dashboard') }}/assets/images/users/avatar-4.jpg" alt="avatar-4 images">
                                                        </div>
                                            ...
                                            <div class="d-flex align-items-start border-bottom py-4">
                                                <div class="flex-shrink-0 me-2">
                                                    <img class="rounded-circle avatar-sm" src="{{ asset('dashboard') }}/assets/images/users/avatar-5.jpg" alt="avatar-5 images">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-start border-bottom py-4">
                                                <div class="flex-shrink-0 me-2">
                                                    <img class="rounded-circle avatar-sm" src="{{ asset('dashboard') }}/assets/images/users/avatar-7.jpg" alt="avatar-7 images">
                                                </div>
            ...
            <div class="tab-pane" id="post" role="tabpanel">
                <div>
                    ...
                    <div class="blog-post">
                        <div class="d-flex align-items-center">
                            <div class="avatar-md me-3">
                                <img src="{{ asset('dashboard') }}/assets/images/users/avatar-6.jpg" alt="" class="img-fluid rounded-circle img-thumbnail d-block">
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="position-relative mt-3">
                            <img src="./{{ asset('dashboard') }}/assets/images/post-1.jpg" alt="" class="img-thumbnail">
                        </div>
                        <div class="pt-3">
                                        ...
                                        <div class="avatar-group">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ asset('dashboard') }}/assets/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-sm">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ asset('dashboard') }}/assets/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-sm">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="ms-2">
                    ...
                    <div class="blog-post mt-4">
                        <div class="d-flex align-items-center">
                            <div class="avatar-md me-3">
                                <img src="{{ asset('dashboard') }}/assets/images/users/avatar-2.jpg" alt="" class="img-fluid img-thumbnail rounded-circle d-block">
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="position-relative mt-3">
                            <img src="./{{ asset('dashboard') }}/assets/images/post-2.jpg" alt="" class="img-thumbnail">
                        </div>
                        <div class="pt-3">
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                                <div>
                                ...
                                <div>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-group">
                                            ...
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ asset('dashboard') }}/assets/images/users/avatar-7.jpg" alt="" class="rounded-circle avatar-sm">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img src="{{ asset('dashboard') }}/assets/images/users/avatar-6.jpg" alt="" class="rounded-circle avatar-sm">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="ms-2">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table align-middle table-nowrap mb-0">
                    <tbody>
                        <tr>
                            <td style="width: 50px;"><img src="{{ asset('dashboard') }}/assets/images/users/avatar-2.jpg" class="rounded-circle avatar-sm" alt=""></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="{{ asset('dashboard') }}/assets/images/users/avatar-1.jpg" class="rounded-circle avatar-sm" alt=""></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="{{ asset('dashboard') }}/assets/images/users/avatar-4.jpg" class="rounded-circle avatar-sm" alt=""></td>
                            <td>
