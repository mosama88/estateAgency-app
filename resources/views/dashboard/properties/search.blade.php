...
<div class="table-responsive">
    ...
    @if (count($property) > 0)
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('dashboard.property.show', $properties->id) }}" class="btn btn-info waves-effect waves-light">عرض</a>
                </td>
                <td>
                    <a href="{{ route('dashboard.property.edit', $properties->id) }}" class="btn btn-success waves-effect waves-light">تعديل</a>
                </td>
                <td>
